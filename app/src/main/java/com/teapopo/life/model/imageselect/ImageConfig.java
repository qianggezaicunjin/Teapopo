...
public class ImageConfig extends BaseEntity{
    ...
    public static class Builder implements Serializable {
        ...
        @ColorRes
        private int titleBgColor = com.yancy.imageselector.R.color.blue;
        @ColorRes
        private int titleTextColor = com.yancy.imageselector.R.color.white;
        @ColorRes
        private int titleSubmitTextColor = com.yancy.imageselector.R.color.white;

        @ColorRes
        private int steepToolBarColor = com.yancy.imageselector.R.color.blue;
