package com.teapopo.life.view.WheelView.PickerView;

import android.view.View;


import com.teapopo.life.R;
import com.teapopo.life.view.WheelView.WheelView;
import com.teapopo.life.view.WheelView.adapter.ArrayWheelAdapter;
import com.teapopo.life.view.WheelView.listener.OnItemSelectedListener;
...
//			len = 12;
		...
		if (mOptions2Items != null)
			wv_option2.setAdapter(new ArrayWheelAdapter(mOptions2Items.get(0),len2));// 设置显示数据
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				if (mOptions3Items != null) {
					...
					//如果没有第三级的数据,则隐藏
					if(mOptions3Items.get(opt1Select).get(index)==null){
						Timber.d("mOptions3Items.get(opt1Select).get(index)为空");
						Timber.d("省的位置为: %d ,市的位置为:%d",opt1Select,index);
						Timber.d("%s",mOptions1Items.get(opt1Select));
						wv_option3.setVisibility(View.GONE);
					}else {
